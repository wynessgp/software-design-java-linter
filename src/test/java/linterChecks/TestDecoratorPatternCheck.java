...
public class TestDecoratorPatternCheck {
    ...
    public void decoratorPatternPasses_HasConcreteClasses_HappyPath() {
        ...
        assertEquals(res.get(3),
                "\t\tAbstract decorators: [decorator-check.AbstractComponentDecorator] \n");
        assertEquals(res.get(4),
                "\t\tConcrete decorators: [decorator-check.ConcreteDecoratorOne, decorator-check.ConcreteDecoratorTwo]\n");
